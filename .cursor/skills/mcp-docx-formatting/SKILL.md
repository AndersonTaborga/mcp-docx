...
description: Uses create_document_formatted with content_blocks (heading, paragraph, list_bullet), title, subtitle, and default font. Use when the user asks for a "formatted" document, "with headings", "with bullet lists", or "professional" .docx output.
